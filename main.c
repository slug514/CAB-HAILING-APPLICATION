...
void assignCarTypes(Driver drivers[], Graph *graph, int numDrivers, int numMini,int numSedan, int numSuv, int numBike, int numAuto) {
  ...
  for (i = 0; i < numDrivers; i++) {
    if (i < numMini) {
      ...
      strcpy(drivers[i].carType, "bike \U0001F3CD\uFE0F");
...
void registerUser() {
  ...
  while (1) {
    ...
    if (password_strength(user.password)) {
      while (1) {
        printf("\nConfirm password: ");
  ...
  do {
    ...
    if (Ph_No_check(user.phoneNumber)) {
      break;
    } else {
  ...
  if (fptr != NULL) {
    ...
    fclose(fptr);
    printf("\033[1;32mYour Account has been Created.\033[0m\n");
  } else {
...
void cab_allot() {
  ...
  while (choice != 5) {
    ...
    case 1: {
      ...
      if (confirm == 'y' || confirm == 'Y') {
        ...
        case 2: {
          ...
          printf("\n\033[1;40m\033[1;37m Thank you for using our service! We "
                 "hope you had a comfortable ride. \033[0m\n");

          // Ask for feedback

          int feedback;
          printf("\n\nPlease rate your ride experience (1-5, 5 being "
                 "excellent): ");
          scanf("%d", &feedback);
          ...
          if (feedback >= 4) {
            printf("\n\n\033[1;32m Thank you for your positive feedback! We "
                   "are glad you had a great ride with us. \033[0m\n");
          } else if (feedback >= 3) {
            printf("\n\n\033[1;33m Thank you for your feedback! We will work "
                   "on improving your experience. \033[0m\n");
          } else {
            printf(
                "\n\n\033[1;31m We apologize for any inconvenience you faced "
                "during the ride. We will make sure to improve. \033[0m\n");
          }
        ...
        if (action == '1') {
          printf("\033[1;91mYour is Cancelled\033[0m\n");
          float cancellationFee = 0.3 * j;
          ...
          printf("\nFinal Price: Rs %.2f\n", finalPrice);
          // After completing the ride
          printf("\\nn\033[1;40m\033[1;37m Thank you for using our service! We "
                 "hope you had a comfortable ride. \033[0m\n");
          ...
          // Display thank you message based on feedback
          if (feedback >= 4) {
            printf("\\nn\033[1;32m Thank you for your positive feedback! We "
                   "are glad you had a great ride with us. \033[0m\n");
          } else if (feedback >= 3) {
            printf("\n\n\033[1;33m Thank you for your feedback! We will work "
                   "on improving your experience. \033[0m\n");
    ...
    case 2: {
      showlocations(&graph);
      do {
        printf("Enter Pickup Location (0-24): ");
        ...
        if (pickupLocation < 0 || pickupLocation > 24) {
          printf("Invalid Pickup Location! Please enter a value between 0 "
                 "and 24.\n");
        }
      } while (pickupLocation < 0 || pickupLocation > 24);

      do {
        printf("Enter Drop Location (0-24): ");
        ...
        if (dropLocation < 0 || dropLocation > 24) {
          printf("Invalid Drop Location! Please enter a value between 0 and "
                 "24.\n");
        }
